...
* LangChain
  ...
  + [SQL agent](/oss/python/langchain/sql-agent)
  + [Supervisor agent](/oss/python/langchain/supervisor)
  + [Voice agent](/oss/python/langchain/voice-agent)
* LangGraph
...
[LangChain](/oss/python/langchain/knowledge-base)
# Build a RAG agent with LangChain
Copy page
Copy page
## [​](#overview) Overview
...
```
## [​](#1-indexing) 1. Indexing
**This section is an abbreviated version of the content in the [semantic search tutorial](/oss/python/langchain/knowledge-base).**If your data is already indexed and available for search (i.e., you have a function to execute a search), or if you’re comfortable with [document loaders](/oss/python/langchain/retrieval#document_loaders), [embeddings](/oss/python/langchain/retrieval#embedding_models), and [vector stores](/oss/python/langchain/retrieval#vectorstores), feel free to skip to the next section on [retrieval and generation](/oss/python/langchain/rag#2-retrieval-and-generation).
...
Previous](/oss/python/langchain/knowledge-base)[Build a SQL agent
Next](/oss/python/langchain/sql-agent)
⌘I
